...
(define (valida-cartas-limite-jogador jogador limite)
  (cond
    [(empty? (jogador-cartas jogador)) empty]
    [(< (carta-valor (first (jogador-cartas jogador))) limite)
     (cons
      (make-cartaptlm (first (jogador-cartas jogador)) (carta-valor (first (jogador-cartas jogador))) limite)
      (cartas-pontos-limite (monta-jogador-resto-cartas jogador) limite))]
    [else (cartas-pontos-limite (monta-jogador-resto-cartas jogador) limite)]
  )
)
